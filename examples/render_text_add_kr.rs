...
const D2_KR: &[u8] = include_bytes!("../assets/fonts/D2Coding-Ver1.3.2-20180524.ttf");
...
async fn main() {
  ...
  fonts
    .load_font_from_bytes("Noto Sans JP", NOTO_SANS_JP)
    .unwrap();
  fonts.load_font_from_bytes("D2", D2_KR).unwrap();
  ...
  loop {
    ...
    fonts.draw_text("한글 테스트", 20.0, 268.0, 69., Color::from([1.0; 4]));
